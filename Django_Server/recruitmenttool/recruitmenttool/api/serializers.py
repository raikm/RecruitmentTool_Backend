...
class CriteriaSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model = Criteria
        fields = ('name', 'description', 'date', 'only_current_patient_cohort', 'criteriums')


class PatientmSerializer(serializers.HyperlinkedModelSerializer):
     class Meta:
         model = Patient
         fields = ('Title', 'First_Name', 'Middle_Name', 'Last_Name', 'Birthdate')
...
class CDAFile(serializers.HyperlinkedModelSerializer):
     ...
     class Meta:
         model = CDAFile
         fields = ('Name', 'Path', 'File', 'File_Date', 'Upload_Date', 'patient')
