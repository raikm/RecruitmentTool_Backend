...
class Criteria(models.Model):
    ...
    description = models.CharField(max_length=600, blank=True, default='Keine Beschreibung')
...
class Criterium(models.Model):
    ...
    criteria = models.ForeignKey(Criteria, related_name='criteriums', on_delete=models.CASCADE)

    class Meta:
        unique_together = ['criteria']

#extracted from the XMLs
